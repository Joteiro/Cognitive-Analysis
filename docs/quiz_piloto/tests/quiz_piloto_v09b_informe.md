...
Generado 2026-08-19 13:39 UTC · modelo `gemini-2.5-flash` · 2.6 min de ejecucion · version `quiz-0.9`
...
| Contestables sin ver el video | 8 | 53 % de las evaluadas |
| **Sobreviven** | **7** | **39 %** |

Preguntas utiles por video: 2.3 de 6 generadas.
...
Control sin video: eligio 3 (seguridad alta) → fallo, sobrevive

**SOBREVIVE** — _TRUMP DESTRUYE LA IMAGEN DE EEUU y el turismo le está pasando factura - @SoloFonseca_

> ¿Cuál es la principal razón que el narrador atribuye a la destrucción de la imagen de Estados Unidos bajo la administración de Trump?

0. El aumento de la violencia en las ciudades americanas.
1. La guerra comercial con China y otros países.
2. La suspensión de visados a 75 naciones.
3. La creencia de que el poder duro es todo lo que se necesita. ✔

Cita (literal): «Pero esto está cambiando bajo Trump. La creencia de que el poder duro es todo lo que necesitas es patente.»
Control sin video: eligio 2 (seguridad media) → fallo, sobrevive
